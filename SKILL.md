...
description: 将考研教材、课件、讲义、截图、OCR、PDF 和学习记录整理为本地可追溯知识库，并通过老师式自然语言交互提供带来源检索、问答、复习、学习建议和基于教材原页的可视化解释路由。适用于 Windows、Obsidian 和中文考研资料；当用户希望直接描述学习目标或卡点，由技能自动定位本地教材、选择高效工作流、按书中代码或变量讲解、制作交互演示，或决定是否沉淀学习记录时使用。
---
